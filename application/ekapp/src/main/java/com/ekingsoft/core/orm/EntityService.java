...
import com.ekingsoft.core.utils.ServiceException;
...
public abstract class EntityService<T, PK extends Serializable> {
    ...
    @Transactional(readOnly = true)
    public Page<T> search(final Page<T> page, final String hql,
            final Object... values) {
    ...
    public boolean isPropertyUnique(final String propertyName,
        ...
        return getEntityDao()
                .isPropertyUnique(propertyName, newValue, oldValue);
    }
